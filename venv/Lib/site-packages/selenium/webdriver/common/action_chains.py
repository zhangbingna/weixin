...
class ActionChains(object):
    ...
    ActionChains can be used in a chain pattern::
        ...
        menu = drive.find_element_by_css_selector(".nav")
        hidden_submenu = drive.find_element_by_css_selector(".nav #submenu1")

        ActionChains(drive).move_to_element(menu).click(hidden_submenu).perform()
    ...
    def __init__(self, driver):
        ...
        :Args:
         - drive: The WebDriver instance which performs user actions.
        """
        self._driver = driver
        self._actions = []
        if self._driver.w3c:
    ...
    def key_down(self, value, element=None):
        ...
        Example, pressing ctrl+c::
            ...
            ActionChains(drive).key_down(Keys.CONTROL).send_keys('c').key_up(Keys.CONTROL).perform()
