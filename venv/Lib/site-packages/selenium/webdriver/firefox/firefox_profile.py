...
class FirefoxProfile(object):
    ...
    def __init__(self, profile_directory=None):
        ...
        :args:
         - profile_directory: Directory of profile that you want to use. If a
           ...
           will be used by the drive when instantiated.
        ...
        if not FirefoxProfile.DEFAULT_PREFERENCES:
            with open(os.path.join(os.path.dirname(__file__),
                ...
                FirefoxProfile.DEFAULT_PREFERENCES = DealJson.load(default_prefs)
        ...
        try:
            with open(userjs) as f:
                for usr in f:
                    ...
                    try:
                        self.default_preferences[matches.group(1)] = DealJson.loads(matches.group(2))
                    except Exception:
    ...
    def _addon_details(self, addon_path):
        ...
        def parse_manifest_json(content):
            ...
            manifest = DealJson.loads(content)
            try:
