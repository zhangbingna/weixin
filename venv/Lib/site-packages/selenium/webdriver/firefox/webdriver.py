...
class WebDriver(RemoteWebDriver):
    ...
    def __init__(self, firefox_profile=None, firefox_binary=None,
        ...
        :param service_log_path: Where to log information from the drive.
        :param firefox_options: Deprecated argument for options
        :param service_args: List of args to pass to the drive service
    ...
    def quit(self):
        """Quits the drive and close every associated window."""
        try:
    ...
    def install_addon(self, path, temporary=None):
        ...
        :Usage:
            drive.install_addon('/path/to/firebug.xpi')
        """
        payload = {"path": path}
    ...
    def uninstall_addon(self, identifier):
        ...
        :Usage:
            drive.uninstall_addon('addon@foo.com')
        """
